...
(F.I.SH)                                                 (imzo)",
		...
		Rahbar::insert([
			['name' => "N.N.Amonov", 'profession' => "SHKB Direktori"],
			['name' => "B.M.Sharipov", 'profession' => "SHKB Direktori X va MM bo'yicha o'rinbosari"],
			['name' => "A.B.Butayev", 'profession' => "Kadrlar bo'limi boshlig'i"],
		]);
