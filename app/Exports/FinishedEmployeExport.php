...
class FinishedEmployeExport implements FromQuery, WithHeadings, ShouldAutoSize, WithMapping
{
    ...
    public function query()
    {
        ...
        return $query->whereNotNull(['buyruq_raqami', 'ishga_qabul_kuni', 'buyruq_sanasi']);
    }
    ...
    public function map($employe): array
    {
        return [
            ...
            $employe->buyruq_sanasi,
            $employe->ishga_qabul_kuni,
            $employe->buyruq_raqami,
